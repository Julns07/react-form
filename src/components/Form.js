...
export default props => {
  ...
  function handleSubmit(e) {
    // area will show alerts when incorrectly inpoutting info
    e.preventDefault()
  ...
  //section will indicate when user encounters errors for not submitting required info
  return (
    <form onSubmit={handleSubmit}>
      ...
      <br />
      <br />
      <label className={cpasswordError ? "error" : ""} htmlFor="cpassword">
        Confirm Password{cpasswordError && cpasswordError}
      </label>{" "}
      <br />
      <input
        className={cpasswordError ? "error" : ""}
        type="password"
        id="cpassword"
        placeholder="password"
        value={cpassword}
      ...
      <label className={websiteError ? "error" : ""} htmlFor="website">
        Your Website {websiteError && websiteError}
      </label>{" "}
      <br />
      <input
        ...
        type="url"
        id="website"
        placeholder="https://www.johnsmith65.com"
        value={website}
